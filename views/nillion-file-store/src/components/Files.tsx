...
export default function Files({ files, handleGetQuote, deleteFile, profiles }: FileProps) {
  return (
    <>
      <div style={{ width: '100%' }}>
          ...
          <div className={styles.file} key={index}>
            <div style={{ maxWidth: '160px', minWidth: '80px' }}>
              ...
              <j-flex a="center" j="start" gap="200">
                <j-avatar size="xs" src={profiles.get(file.author)?.profileImage} hash={file.author}></j-avatar>
            ...
            <j-flex a="center" j="between" gap="200" direction="row">
              ...
              <j-button
                ...
                variant="subtle"
                size="sm"
                onClick={() => handleGetQuote(file.name, file.storeId, file.secretId)}
              >
