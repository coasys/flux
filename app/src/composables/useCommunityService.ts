...
export interface ChannelData {
  channel: Partial<Channel> & { children?: ChannelData[] };
...
export async function createCommunityService(): Promise<CommunityService> {
  ...
  async function getPinnedConversations() {
    ...
    // Get the conversation for each pinned channel
...
//     console.log("getChannelsWithConversations:", channelsWithConversations.value);
//     channelsWithConversationsLoading.value = false;
//   }
...
// //   channelsWithConversations.value = newRootChannels;
// //   channelsWithConversationsLoading.value = false;
// // }
