<template>
  <j-modal :open="modalStore.showEditProfile" @toggle="(e: any) => (modalStore.showEditProfile = e.target.open)">
    <j-box p="800" :style="{ display: hideContainer ? 'none' : 'block' }">
      <j-flex direction="column" gap="700">
        ...
        />
        <j-flex gap="300">
          <j-button size="lg" @click="modalStore.showEditProfile = false"> Cancel </j-button>
