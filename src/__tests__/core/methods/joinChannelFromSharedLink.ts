...
describe('Join Channel From Shared Link', () => {
  test('Find Name Description From Meta - Success', async () => {
    ...
    const { neighbourhood, state } = await joinChannelFromSharedLink('neighbourhood://842124eeeaeb37f2ef108525280f390e52dec874329c7ac2b9b65636f5d9df27e9f8d7f4ee8d56', "bebd2ac2-1e80-44d2-b807-0163c2bcef40");
    ...
    expect(neighbourhood.neighbourhoodUrl).toBe('neighbourhood://842124eeeaeb37f2ef108525280f390e52dec874329c7ac2b9b65636f5d9df27e9f8d7f4ee8d56');
  })
});