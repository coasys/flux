...
export function subscribeToPerspective(perspective: PerspectiveProxy, added: Function, removed: Function) {
...
export function unsubscribeToPerspective(perspective: PerspectiveProxy, added: Function, removed: Function) {
  const addedKey = `perspective-${perspective.uuid}-added`;
  const removedKey = `perspective-${perspective.uuid}-removed`;
