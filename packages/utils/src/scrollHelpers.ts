...
export function isAtBottom(scrollContainer: HTMLElement | null, offset = 0): boolean {
  ...
  return scrollContainer.scrollTop >= scrollContainer.scrollHeight - offset - scrollContainer.offsetHeight;
}
