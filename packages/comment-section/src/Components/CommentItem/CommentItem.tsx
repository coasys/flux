  ...
  return (
    <div className={styles.container}>
      <a href={comment.author} className={styles.link}>
        <Avatar size="sm" did={comment.author} src={profile?.profileThumbnailPicture}></Avatar>
      </a>
      ...
      <div></div>
      <div className={styles.comment} dangerouslySetInnerHTML={{ __html: comment?.body }}></div>
    </div>
  );
}
